...
<h1 class="card-title text-center" style="float: center;" >Login </h1>
...
<input type="text" class="form-control" name="usuario" id="inputEmail3" placeholder="Usuario">
  ...
  <button type="submit" style="margin-bottom: 25px; margin-top: 25px;" class="btn btn-outline-success btn-lg">Iniciar session</button>
